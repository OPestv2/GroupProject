...
<main class="form-signin text-center m-auto">
    ...
    <form>
        ...
        <button class="w-100 btn btn-lg btn-primary mb-2" type="submit">Zarejestruj</button>
        <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-lg btn-light w-100">Zaloguj się</a>
